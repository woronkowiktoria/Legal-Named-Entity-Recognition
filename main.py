...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="data/NER_DEV/NER_DEV_JUDGEMENT.json",
        required=False,
        type=str,
    )
    parser.add_argument(
    ...
    ds_test_path = args.ds_test_path
    ...
    def compute_metrics(pred):
     ...
     #  "saibo/legal-roberta-base",                 # ft on Legal Domain    # LUKE base
     #   "studio-ousia/luke-large",                  # LUKE large
     #"studio-ousia/luke-base", # ft on ECHR
